...
class OrderService {
  ...
  async syncItems(items) {
    ...
    await this.model.items().crateMany(items, this.trx)
  }
  ...
  async canApplyDiscount(coupon) {
    ...
    // verificar se o cupom não está associao a produtos e clientes específicos
    if (
      ...
      /**
       * caso nao este associao a cliente ou prouto específico, é de uso livre
       */
      return true
    }
    ...
    */
    ...
    /*
    * caso de uso 2 - O cupom está apenas associado a produto
    */
    ...
    */
    ...
    /*
    * caso nenhuma das verificações seja positivas
    * então o cupom está associado a clientes ou produtos ou os dois
    * porem nenhum dos produtos deste pedido está elegível ao desconto
    *  e o cliente que fez a compra também não poderá utilizar esse cupom
    */
    return false
